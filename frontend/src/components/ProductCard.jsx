...
const s = {
  ...
  name: { margin: 0, fontFamily: theme.fontDisplay, fontSize: 19, fontWeight: 500, letterSpacing: "0.01em" },
  fit: { margin: "2px 0 0", fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: theme.muted },
  price: { margin: "8px 0 0", fontSize: 12, letterSpacing: "0.08em", color: theme.white },
  ...
  colorDot: (hex, active) => ({
    ...
    borderRadius: "50%",
    background: hex,
    border: active ? `2px solid ${theme.white}` : "2px solid transparent",
    outline: active ? `1px solid ${theme.white}` : "none",
    outlineOffset: 1,
    cursor: "pointer",
  ...
  addBtn: (added) => ({
    ...
    width: "100%",
    padding: "9px 0",
    border: `1px solid ${added ? theme.forest : "rgba(255,255,255,0.14)"}`,
    borderRadius: 6,
    background: added ? "rgba(15,91,70,0.35)" : "transparent",
    color: added ? theme.white : theme.lightGray,
    fontSize: 10,
