...
// Filter categories for women's page
const WOMEN_FILTERS = [
  { id: "all", name: "All" },
...
export default function Women() {
  ...
  // Filter products for women — adjust the condition to match your data shape
  ...
  const s = {
    ...
    heroBg: {
      ...
      background: `linear-gradient(to top, ${theme.ink} 4%, rgba(11,11,12,0.80) 34%, rgba(11,11,12,0.38) 100%),
        radial-gradient(90% 60% at 75% 25%, rgba(192,142,90,0.18), transparent 60%),
    ...
    <main id="top">
      ...
      <section style={s.hero}>
        ...
        <div style={s.heroInner}>
          <span style={label}>Women&rsquo;s collection</span>
          ...
          <div style={s.heroActions}>
            ...
            <a href="/men" style={{ ...btnGhost, ...s.heroBtn }}>Shop men</a>
          </div>
        </div>
      </section>
      ...
      <section style={s.section} id="products">
        <div style={s.head}>
          <span style={label}>Women&rsquo;s scrubs</span>
          <h2 style={s.title}>
            {activeFilter === "all"
              ? "All pieces"
